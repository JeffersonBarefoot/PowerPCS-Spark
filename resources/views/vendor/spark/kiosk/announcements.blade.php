        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    {{__('...test...Announcements you create here will be sent to the "Product Announcements" section of the notifications modal window, informing your users about new features and improvements to your application.')}}
                </div>
